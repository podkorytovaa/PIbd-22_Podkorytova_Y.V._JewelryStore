...
namespace JewelryStoreListImplement.Implements
{
    public class ImplementerStorage : IImplementerStorage
    {
        ...
        public static Implementer CreateModel(ImplementerBindingModel model, Implementer implementer)
        {
        ...
        public static ImplementerViewModel CreateModel(Implementer implementer)
        {
