...
namespace JewelryStoreView
{
    internal static class Program
    {
        ...
        private static IUnityContainer BuildUnityContainer()
        {
            ...
            currentContainer.RegisterType<IWarehouseStorage, WarehouseStorage>(new HierarchicalLifetimeManager()); currentContainer.RegisterType<IComponentLogic, ComponentLogic>(new HierarchicalLifetimeManager());
